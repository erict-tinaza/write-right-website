...
function defaultPageContent(str){
  ...
  <div
    id="ea"
    class="flex items-center justify-center h-24 rounded bg-cyan-600"
  >
    <p id="banner-el" class="text-2xl text-white dark:text-gray-500">
      ${str}
    </p>
  </div>
</div>
...
function creativeWritingContent(){
  ...
  <button
    type="submit"
    class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-900 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800"
  >
    Save
  </button>
</form>
